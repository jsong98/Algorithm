...
//			double weight = succProb[i];
//			
//			list.add(new double[] {start, end, weight});
//		}
//		
//		double[] dis = new double[n+1];
//		dis[start_node] = 1.0;
//		
//		PriorityQueue<double[]> que = new PriorityQueue<>((a,b) -> (int)b[1]*100 - (int)a[1]*100);
////		Queue<double[]> que = new LinkedList<>();
//		que.add(new double[] {start_node, 1});
//		
//		while(!que.isEmpty()) {
//			double[] cur = que.poll();
...
//			for(double[] arr : list) {
//				if(arr[0]==curNode) {
//					double nextWeight = arr[2];
//					if(curWeight * nextWeight > dis[(int) arr[1]]) {
//						dis[(int) arr[1]] = curWeight * nextWeight;
//						que.add(new double[] {(int) arr[1], dis[(int) arr[1]]});
//					}
//				} else if(arr[1]==curNode) {
//					double nextWeight = arr[2];
//					if(curWeight * nextWeight > dis[(int) arr[0]]) {
//						dis[(int) arr[0]] = curWeight * nextWeight;
//						que.add(new double[] {(int) arr[0], dis[(int) arr[0]]});
//					}
//				}
//			}
//		}
